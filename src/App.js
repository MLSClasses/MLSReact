...
import act_math from  "./assets/img/act_math.jpeg"
    ...
    <div class="body">
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/act_english" element={<ACT_READING_WRITING banner_img={act_math} headingText={act_english_heading} mainContent={act_english} conclusion={act_english_conclusion} />}></Route>
          <Route path="/act_math" element={<ACT_READING_WRITING banner_img={act_math} headingText={act_english_heading} mainContent={act_english} conclusion={act_english_conclusion} />}></Route>
          <Route path="/sat_reading_writing" element={<ACT_READING_WRITING feedback={true} banner_img={sat_r_w} headingText={sat_reading_writing_heading} mainContent={sat_reading_writing} conclusion={sat_reading_writing_conclusion} />}></Route>
