    ...
    <div class="body">
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/act_english" element={<ACT_READING_WRITING banner_img={act_math_img} headingText={act_english_heading} mainContent={act_english} conclusion={act_english_conclusion} />}></Route>
