...
const Term = () => {
    ...
    <p class='content-text'>
        The term 'MLS Classes' or 'us' or 'we' refers
        to the owner of the website whose registered/operational office is
        first floor, 22, mahendra kirana store, dhakar colony
        Tonk
        RAJASTHAN
        304505. The term 'you' refers to the user or viewer of our website.
    </p>
    <p class='content-text'>
